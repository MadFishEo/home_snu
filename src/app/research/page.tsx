...
export const metadata: Metadata = {
  title: "연구 프로그램 | SNU Institute - 서울대학교차세대연구원",
  description:
    "서울대학교차세대연구원의 차세대 기술 연구 프로그램과 연구 분야를 소개합니다.",
};
...
const researchAreas: ResearchArea[] = [
  ...
  },
  {
    ...
    title: "우주과학",
    projects: 8,
    desc: "소형 위성 시스템, 우주 탐사 기술, 위성 데이터 활용 연구",
    tags: ["큐브샛", "우주추진", "원격탐사"],
  },
  {
    icon: "⚡",
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {area.tags.map((tag) => (
                  <span
                    key={tag}
                    className="text-xs bg-green-50 dark:bg-green-900/20 text-snu-green dark:text-green-400 px-2 py-1 rounded-full"
                  >
                    {tag}
                  </span>
                ))}
