...
const milestones: Milestone[] = [
  {
    year: "2005",
    text: "서울대학교차세대연구원 설립 — 차세대 기술 연구 전문기관 개원",
  },
  {
    year: "2010",
    text: "양자기술연구센터 개소 — 국내 최초 양자컴퓨팅 연구 시작",
  },
  {
    year: "2015",
    text: "글로벌 연구 허브 구축 — 해외 12개국 기관과 공동 연구 협약",
  },
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
              ...
              생명과학, 미래에너지 분야에서 인류의 지속가능한 미래를 위한
              원천기술을 연구합니다.
            </p>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
              우리는 도전적이고 창의적인 연구 환경을 조성하여 미래 사회가 필요로
              하는 차세대 핵심 기술을 선도적으로 개발하고 글로벌 기술 경쟁력을
              강화합니다.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              >
                <p className="text-3xl font-bold text-snu-green dark:text-green-400">
                  {stat.value}
                </p>
          ...
          <div className="relative border-l-2 border-snu-green dark:border-green-600 pl-8 space-y-8">
            {milestones.map((m) => (
              <div key={m.year} className="relative">
                ...
                <span className="text-snu-green dark:text-green-400 font-bold text-sm">
                  {m.year}
                </span>
