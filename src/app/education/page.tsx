...
export const metadata: Metadata = {
  title: "교육 프로그램 | SNU Institute - 서울대학교차세대연구원",
  description:
    "차세대 기술을 이끌 미래 인재를 양성하는 서울대학교차세대연구원의 학위 및 온라인 교육 프로그램입니다.",
};
            ...
            {onlinePrograms.map((course) => (
              ...
              >
                <div className="w-14 h-14 bg-snu-green/10 dark:bg-green-900/30 rounded-xl flex items-center justify-center flex-shrink-0">
                  <span className="text-snu-green dark:text-green-400 font-bold text-lg">
                    S
                  </span>
                </div>
