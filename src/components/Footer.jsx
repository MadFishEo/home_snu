      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              차세대 기술 연구를 선도하는 서울대학교차세대연구원은 양자기술,
              반도체, 우주과학, 생명과학, 미래에너지 분야에서 인류의 미래를
              열어갑니다.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="mt-2">
                <Link
                  to="/contact"
                  className="inline-flex items-center px-4 py-2 bg-snu-green text-white text-sm rounded-2xl hover:bg-green-600 transition-colors"
                >
                  문의하기
                </Link>
              </li>
        ...
        <div className="border-t border-green-900 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-500">
            © 2026 SNU Institute. All rights reserved.
          </p>
